...
cdef class PyQProblem:
    ...
    cdef getPrimalSolution(self, np.ndarray[np.double_t, ndim=1] xOpt):
        return self.thisptr.getPrimalSolution(<real_t*> xOpt.data)

    cdef getDualSolution(self, np.ndarray[np.double_t, ndim=1] yOpt):
        return self.thisptr.getDualSolution(<real_t*> yOpt.data)

    cdef getObjVal(self):
        return self.thisptr.getObjVal()

    cdef printOptions(self):
        return self.thisptr.printOptions()

    cdef setOptions(self, PyOptions options):
        self.thisptr.setOptions(deref(options.thisptr))
...
cdef class PySolutionAnalysis:
    ...
    cdef _getKktViolation_QProblemB(self,
            PyQProblemB qp,
            np.ndarray[np.double_t, ndim=1] maxStat,
            np.ndarray[np.double_t, ndim=1] maxFeas,
            np.ndarray[np.double_t, ndim=1] maxCmpl
    ...
    cdef _getKktViolation_QProblem(self,
            PyQProblem qp,
            np.ndarray[np.double_t, ndim=1] maxStat,
            np.ndarray[np.double_t, ndim=1] maxFeas,
            np.ndarray[np.double_t, ndim=1] maxCmpl
    ...
    cdef _getKktViolation_SQProblem(self,
            PySQProblem qp,
            np.ndarray[np.double_t, ndim=1] maxStat,
            np.ndarray[np.double_t, ndim=1] maxFeas,
            np.ndarray[np.double_t, ndim=1] maxCmpl
    ...
    cdef getVarianceCovariance(self,
                              qp,
    ...
    cdef _getVarianceCovariance_QProblemB(self,
                              PyQProblemB qp,
                              np.ndarray[np.double_t, ndim=1] g_b_bA_VAR,
                              np.ndarray[np.double_t, ndim=1] Primal_Dual_VAR ):
    ...
    cdef _getVarianceCovariance_QProblem(self,
                              PyQProblem qp,
                              np.ndarray[np.double_t, ndim=1] g_b_bA_VAR,
                              np.ndarray[np.double_t, ndim=1] Primal_Dual_VAR ):
        return self.thisptr.getVarianceCovariance(qp.thisptr,
    ...
    cdef _getVarianceCovariance_SQProblem(self,
                              PySQProblem qp,
                              np.ndarray[np.double_t, ndim=1] g_b_bA_VAR,
                              np.ndarray[np.double_t, ndim=1] Primal_Dual_VAR ):
        return self.thisptr.getVarianceCovariance(qp.thisptr,
...
cdef py_runOqpBenchmark(path,               # Full path of the benchmark files (without trailing slash!).
