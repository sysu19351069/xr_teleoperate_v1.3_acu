...
int mpc2qp(const int NUM_CTRL, const int NUM_JONT, const double dt,
    ...
    G.block(3 * NUM_JONT * NUM_CTRL + 1, 0, 2 * NUM_JONT, NUM_JONT * (NUM_CTRL + 1)) = Gmoas;
    ...
    qmax_umax << qmax, umax;
    lbA.block(3 * NUM_JONT * NUM_CTRL + 1, 0, 2 * NUM_JONT, 1) = qmin_umin + Ce * Epsilon.block(2 * NUM_JONT * (NUM_CTRL - 1), 0, 2 * NUM_JONT, 1);
    ubA.block(3 * NUM_JONT * NUM_CTRL + 1, 0, 2 * NUM_JONT, 1) = qmax_umax + Ce * Epsilon.block(2 * NUM_JONT * (NUM_CTRL - 1), 0, 2 * NUM_JONT, 1);
